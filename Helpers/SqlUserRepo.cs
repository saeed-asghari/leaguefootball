...
{
    public class SqlUserRepo : IUserService
    {
        private readonly LeaguesDataContext _context;
        private readonly AppSettings _appSettings;

        public SqlUserRepo(LeaguesDataContext context, IOptions<AppSettings> appSettings)
        {
            _context = context;
            _appSettings = appSettings.Value;
        }

        public AuthenticateResponse Authenticate(AuthenticateRequestModel model, string ipAddress)
        {
